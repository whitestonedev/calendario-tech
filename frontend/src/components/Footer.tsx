    ...
    <footer className="bg-tech-dark text-white py-8 mt-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h3 className="text-xl font-bold mb-2">
              <img src="img/logotipo_white.png" alt="WhiteStone Dev Logo" className="max-h-12" />
            </h3>
            <p className="text-gray-300 text-sm mb-1">{t('footer.maintained')}</p>
        ...
        <div className="text-center text-gray-400 text-sm mt-8">
          &copy; {new Date().getFullYear()} whiteStone_dev & Calendario Tech. {t('footer.rights')}
        </div>
      </div>
    </footer>
  );

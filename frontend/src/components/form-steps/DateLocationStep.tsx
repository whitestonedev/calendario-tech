              ...
              <Dialog open={startTimeDialogOpen} onOpenChange={setStartTimeDialogOpen}>
                <DialogContent className="p-4 bg-white rounded-xl shadow-xl w-fit space-y-4">
                  <div className="text-center text-2xl font-semibold text-gray-800 tracking-wide">
                    {tempStartTime ? formatDateToTimeString(tempStartTime) : t('form.selectTime')}
                  </div>
                  <LocalizationProvider dateAdapter={AdapterDateFns}>
                    <StaticTimePicker
                      ...
                      onAccept={(finalValue) => {
                        if (finalValue) {
                          form.setValue('start_time', formatDateToTimeString(finalValue), {
                            shouldValidate: true,
                          });
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <Dialog open={endTimeDialogOpen} onOpenChange={setEndTimeDialogOpen}>
                <DialogContent className="p-4 bg-white rounded-xl shadow-xl w-fit space-y-4">
                  <div className="text-center text-2xl font-semibold text-gray-800 tracking-wide">
                    {tempEndTime ? formatDateToTimeString(tempEndTime) : t('form.selectTime')}
                  </div>
                  <LocalizationProvider dateAdapter={AdapterDateFns}>
                    <StaticTimePicker
                      displayStaticWrapperAs="desktop"
                      ...
                      onAccept={(finalValue) => {
                        if (finalValue) {
                          form.setValue('end_time', formatDateToTimeString(finalValue), {
                            shouldValidate: true,
                          });
